    ...
    <section class="section dashboard">
        ...
        <div class="col-lg-12 p-0">
          <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Tour Category <button type="button" class="new-category btn btn-md btn-primary float-right">Add <i class="bi bi-plus-circle ms-1"></i></button></h5>
      ...
      <form id="addcategory" action="<?=base_url('admin/Tourcategory/save_record')?>" method="POST">
          ...
          <div class="modal-body">
              ...
              <div class="col-md-10 mx-auto">
                <label for="validationDefault02" class="form-label">Tour Category</label>
                <input type="text" maxlength="100" autocomplete="off" class="form-control" name="sub_category" id="validationDefault02" value="" required>
              </div>
          </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#submitcategory").click(function (event) {
        ...
        if( sub_category == "" )
        {
          $("#addcategory input[name='sub_category']").focus();
          return false;
        }
