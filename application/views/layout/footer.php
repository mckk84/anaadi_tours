<footer class="footer-wrapper footer-layout1">
							...
							<div class="widget footer-widget">
								...
								<div class="th-widget-contact">
									<div class="info-box_text">
										...
										<div class="details">
											<p><a href="tel:918048660847" class="info-box_link">+91 80 4866 0847</a></p>
										</div>
									</div>
									<div class="info-box_text">
										<div class="icon"><img src="assets/img/icon/envelope.svg" alt="img"></div>
										<div class="details">
											<p><a href="nandish@anaadi.co" class="info-box_link">nandish@anaadi.co</a></p>
										</div>
									</div>
									<div class="info-box_text">
		...
		<div id="login-form" class="popup-login-register mfp-hide">
			<ul class="nav" id="pills-tab" role="tablist">
				...
				<li class="nav-item" role="presentation"><button class="nav-menu" id="pills-forgot-tab" data-bs-toggle="pill" data-bs-target="#pills-forgot" type="button" role="tab" aria-controls="pills-forgot" aria-selected="true">Forgot Password</button></li>
			</ul>
			<div class="tab-content" id="pills-tabContent">
				...
				<div class="tab-pane fade" id="pills-forgot" role="tabpanel" aria-labelledby="pills-forgot-tab">
					<h3 class="th-form-title mb-30">Forgot Password</h3>
					<form action="https://html.themeholy.com/tourm/demo/mail.php" method="POST" class="login-form ajax-contact">
						<div class="row">
							<div class="form-group col-12"><label for="new_email">Your email*</label> <input type="text" class="form-control" name="new_email" id="new_email" required="required"></div>
							<div class="form-btn mt-20 col-12"><button class="th-btn btn-fw th-radius2">Reset Password</button></div>
						</div>
						<p class="form-messages mb-0 mt-3"></p>
					</form>
				</div>
